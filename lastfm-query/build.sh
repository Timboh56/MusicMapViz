...
mkdir bin
javac -cp .:./lib/java-cup-0.11a-beta-20060608.jar:./lib/last.fm-bindings.jar:./lib/last.fm-bindings.jar:./lib/entity-strip-insert.jar -d bin/ ./generated/it/polito/lastfm/query/* ./src/it/polito/lastfm/query/*
